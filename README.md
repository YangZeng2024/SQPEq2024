...
1. This code is to test the performance of the algorithm on CUTEst or LIBSVM problem. Run "main.jl" to use this code. For example, SQPEq("BT10", 1, 14) or SQPEq("a9a.txt", 500, 2).
2. There are four parts of this code. Both datasdets shares "updating.jl" and "main.jl". "ProblemSetup.jl" and "estimator" are in the folder, repsectively.
